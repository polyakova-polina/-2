...
def error_correction2(circuit, qutrits):
    #get_syndrome(circuit, qutrits)
    # get_syndrome_r(circuit1, qutrits1)
    ...
    circuit1.append([x(q1), x(q4)], strategy=InsertStrategy.INLINE)
    CCCCX(circuit, q1, q2, q3, q4, q1)
    circuit1.append([x(q1), x(q4)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q1), x(q2), x(q3)], strategy=InsertStrategy.INLINE)
    CCCCX(circuit, q1, q2, q3, q4, q2)
    circuit1.append([x(q1), x(q2), x(q3)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q2)], strategy=InsertStrategy.INLINE)
    CCCCX(circuit, q1, q2, q3, q4, q3)
    circuit1.append([x(q2)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q1), x(q2)], strategy=InsertStrategy.INLINE)
    CCCCX(circuit, q1, q2, q3, q4, q4)
    circuit1.append([x(q1), x(q2)], strategy=InsertStrategy.INLINE)
    ...
    circuit1.append([x(q4)], strategy=InsertStrategy.INLINE)
    CCCCY(circuit, q1, q2, q3, q4, q1)
    circuit1.append([x(q4)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q1), x(q3)], strategy=InsertStrategy.INLINE)
    CCCCY(circuit, q1, q2, q3, q4, q2)
    circuit1.append([x(q1), x(q3)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q2), x(q3)], strategy=InsertStrategy.INLINE)
    CCCCY(circuit, q1, q2, q3, q4, q3)
    circuit1.append([x(q2), x(q3)], strategy=InsertStrategy.INLINE)

    CCCCY(circuit, q1, q2, q3, q4, q4)
    ...
    circuit1.append([x(q2), x(q3), x(q4)], strategy=InsertStrategy.INLINE)
    CCCCZ(circuit, q1, q2, q3, q4, q1)
    circuit1.append([x(q2), x(q3), x(q4)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q1), x(q3), x(q4)], strategy=InsertStrategy.INLINE)
    CCCCZ(circuit, q1, q2, q3, q4, q2)
    circuit1.append([x(q1), x(q3), x(q4)], strategy=InsertStrategy.INLINE)

    circuit1.append([x(q1), x(q2), x(q4)], strategy=InsertStrategy.INLINE)
    CCCCZ(circuit, q1, q2, q3, q4, q3)
    circuit1.append([x(q1), x(q2), x(q4)], strategy=InsertStrategy.INLINE)


    circuit1.append([x(q3), x(q4)], strategy=InsertStrategy.INLINE)
    CCCCZ(circuit, q1, q2, q3, q4, q4)
    circuit1.append([x(q3), x(q4)], strategy=InsertStrategy.INLINE)
...
for w1 in range(4):
    for w2 in range(4):
        for w3 in range(4):
            for w4 in range(4):
                for w5 in range(4):
                    codes.append([w1,w2,w3,w4,w5])

z = np.array([1,0,0])
e = np.array([0,1,0])
zl = complex(0, -(1/8**0.5)) * (m(z,z,z,z,z) - m(e,z,e,e,e) - m(z,e,z, e, e)+ m(e,e,e,z,z) + m(e,z,z,e,z)+ m(z,z,e,z,e) + m(e,e,z,z,e) + m(z,e,e,e,z))
...
for c in codes:
    ...
    vsp_f(circuit1, qutrits1[0], c[0])
    vsp_f(circuit1, qutrits1[1], c[1])
    vsp_f(circuit1, qutrits1[2], c[2])
    vsp_f(circuit1, qutrits1[3], c[3])
    vsp_f(circuit1, qutrits1[4], c[4])
    decoding_qubit(circuit1, qutrits1)
    error_correction2(circuit1, qutrits1)
    res1 = sim.simulate(circuit1)
    vec = circuit1.final_state_vector(initial_state=0, qubit_order=qutrits1) - zl
    ...
    for j in range(5):
        qutrits1.append(cirq.LineQid(j, dimension=3))
    circuit1.append([x(qutrits1[0])], strategy=InsertStrategy.INLINE)
    encoding_qubit(circuit1, qutrits1)
    # time_error(circuit1, qutrits1, t)
    vsp_f(circuit1, qutrits1[0], c[0])
    vsp_f(circuit1, qutrits1[1], c[1])
