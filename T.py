...
def encoding_qubit(circuit, log_qubit):
    ...
    svertka(circuit, [q1, q3, q4], 3)
    main_operation(circuit, [q1, q3, q4], q5, 3)
    razvertka(circuit, [q1, q3, q4], q5, 3)
    ...
    svertka(circuit, [q4, q5], 2)
    main_operation(circuit, [q4, q5], q1, 2)
    razvertka(circuit, [q4, q5], q1, 2)
...
h = H()
gates = [x(qutrits1[i]) for i in range(2)]
...
svertka(circuit1, qutrits[0:-1], 4)
main_operation(circuit1, qutrits[0:-1], qutrits[-1], 4)
razvertka(circuit1, qutrits[0:-1], qutrits[-1], 4)
